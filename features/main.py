...
def main():
    ...
    parser.add_argument('--include_hsv', type=str, default="True", help='Include HSV in the plot') #2 choices [True, False]
    ...
    print('include hsv', args.include_hsv)
    plot_umap(total_features_j, img, patch_h*rows, patch_w*cols, width_pad, height_pad, width, height, output_dir=f"{args.output_dir}/UMAP_stride2_3neigh_hsv.png", include_hsv=args.include_hsv)
